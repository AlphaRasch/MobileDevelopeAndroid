...
import ru.chekalinev.mireaproject.databinding.FragmentCameraBinding;
            ...
            public void onClick(View v) {
                ...
                if(isWork) {
                    try {
                        ...
                        String authorities = getContext().getApplicationContext().getPackageName()
                                + ".fileprovider";
